                ...
                <BodyWrapper $scale={scaleBy}>
                    {isMobile ? (
                        <MobileContent style={{maxHeight: height - 100}}>
                            <Header>
                                Добро пожаловать в лабораторию DERCOS
                            </Header>
                            <Text>
                                Проверьте свои знания и самостоятельно создайте средство против выпадения
                                волос <b>AMINEXIL INTENSIVE 5.</b>
                            </Text>
                            <MoleculeBox>
                                <Divider/>
                                <MoleculeWrapper>
                                    <GameIcon>
                                        <img src="/assets/images/dercos/modals/rules/molecules.png" alt="molecules"/>
                                    </GameIcon>
                                    <MoleculeText>
                            ...
                            <Text>
                                ...
                                из лимитированных<br/><b>зонтов от марки VICHY.</b>
                            </Text>
                            <ImageWrapper>
...
export default DercosRulesModal
...
const Container = styled.div`
  ...
  background-image: url('/assets/images/dercos/modals/rules/bg.png');
