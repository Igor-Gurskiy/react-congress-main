...
const CloudForm = ({ tags = [] as any[], addWord = (word: Word) => {} }) => {
	...
	const onSubmit = async (data) => {
		...
		try {
			...
			API.tracker.sendEvent(
				EventsEnum.dercosCloudWordEntry,
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} className={styles.wrapper}>
				...
				{isSubmitted && (
					...
					>
						...
						<div className={clsx(styles.description, styles.fullWidth)}>
							Вы можете добавить еще слова-ассоциации с <b>Dercos</b> и увидите,
							какие ассоциации чаще всего вызывает упоминание бренда
							среди&nbsp;специалистов
						</div>
					</motion.div>
				)}
			...
			{!isSubmitted && (
				<div className={clsx(styles.description, styles.fullWidth)}>
					Впишите свое слово-ассоциацию с <b>Dercos</b> и увидите, какие
