...
import CloudForm from '@/components/screens/dercos/tag-cloud/cloud-form/CloudForm'
import { modifyCloudSetWithWord } from '@/utils/modify-cloud-set'

const MediaQuery = dynamic(() => import('react-responsive'), { ssr: false })

const DercosTagCloud = ({ cloud, preview }) => {
...
export const Wrapper = styled.div`
	background: url(../assets/images/dercos/cloud/bg.jpg);
	...
	`} @media screen and(max-height: 600 px) {
		grid-template-rows: 1fr 1fr;
	}
