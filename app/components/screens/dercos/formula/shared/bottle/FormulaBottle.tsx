	...
	return (
		<BottleContainer id="vichy-bottle">
			<Bottle
				...
				src="/assets/images/dercos/formula/bottle.png"
				alt="Vichy Dercos bottle"
			/>
			<BottleReflection
				src="/assets/images/dercos/formula/reflect.png"
				alt="Vichy Dercos reflect"
			/>
			...
			<ResultBottle
				$visible={state.finished}
				src="/assets/images/dercos/formula/result.png"
				alt="Vichy Dercos result bottle"
			/>
					...
					<FormulaVictory style={{ ...style, transform: `scale(${scaleBy})` }}>
						<Glass>
							<VictoryText>
								ПОЗДРАВЛЯЕМ!
								<br />
								Вы правильно собрали Aminexil Intensive 5 и стали участником
								розыгрыша.
								<br />
