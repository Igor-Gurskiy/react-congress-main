...
import CloudForm from '@/components/screens/lrp/tag-cloud/cloud-form/CloudForm'
import { modifyCloudSetWithWord } from '@/utils/modify-cloud-set'

const MediaQuery = dynamic(() => import('react-responsive'), { ssr: false })

const LRPTagCloud = ({ cloud, preview }) => {
...
export const Wrapper = styled.div`
	background: url(../assets/images/lrp/cloud/bg.jpg);
