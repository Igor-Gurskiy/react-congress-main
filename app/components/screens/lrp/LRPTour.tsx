...
const LRPTour = () => {
	...
	useEffect(() => {
		if (!isLoading && !preloader && tour === 'lrp') {
			setStep(1)
			setHelpTour(false)
		}
		return
	...
	return (
		<Tour open={tour === 'lrp'}>
			{!isMobile && (
				<>
					...
					<Tour.Step
						...
						skip={skip}
					/>
					<Tour.Arrow open={step === 3} left={850} top={220} rotate={270} />
					<Tour.Arrow open={step === 4} left={1470} top={380} rotate={90} />
				</>
			)}

			{isMobile && (
				<>
					<Tour.Arrow open={step === 3} left={410} top={-100} rotate={180} />
					<Tour.Arrow open={step === 4} left={1980} top={-80} rotate={180} />
				</>
			)}

			<Tour.Arrow open={step === 1} left={1170} top={-70} rotate={180} />
			<Tour.Arrow open={step === 2} left={1170} top={-70} rotate={180} />

			<Tour.Light
				src="assets/images/lrp/shelf/light.png"
				open={step === 1}
				top={280}
				left={900}
			/>
			...
			<Tour.Light
				src="assets/images/lrp/light/brochure.png"
				open={step === 2}
				top={825}
				left={1000}
			/>
			...
			<Tour.Light
				src="assets/images/lrp/light/cloud.png"
				open={step === 3}
				top={241}
				left={270}
			/>
			...
			<Tour.Light
				src="assets/images/lrp/light/game-light.png"
				open={step === 4}
				top={265}
				left={1774}
			/>
