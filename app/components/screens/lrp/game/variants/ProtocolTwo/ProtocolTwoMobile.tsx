...
import { case2 } from '@/components/screens/lrp/game/cases/case2'
...
const ProtocolTwoMobile = () => {
	...
	const slots = useLRPGameStore((state) => state.slots2)
			...
			<div className={styles.header}>
				<MediaQuery minDeviceWidth={768} minWidth={768}>
					{(matches) =>
						matches ? (
							<img
								src="/assets/images/lrp/game/case2/bg2.png"
				...
				<MediaQuery maxDeviceWidth={767.98} maxWidth={767.98}>
					{(matches) =>
						matches ? (
							<img
								src="/assets/images/lrp/game/case2/bg3.jpg"
								className={styles.product}
								alt="product"
							/>
						) : null
