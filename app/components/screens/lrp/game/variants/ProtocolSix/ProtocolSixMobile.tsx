...
import styles from './ProtocolSixMobile.module.scss'
			...
			<div className={styles.header}>
				<MediaQuery minDeviceWidth={768} minWidth={768}>
					{(matches) =>
						matches ? (
							<img
								src="/assets/images/lrp/game/case6/bg2.png"
				...
				<MediaQuery maxDeviceWidth={767.98} maxWidth={767.98}>
					{(matches) =>
						matches ? (
							<img
								src="/assets/images/lrp/game/case6/bg3.jpg"
								className={styles.product}
								alt="product"
							/>
						) : null
...
export default ProtocolSixMobile
