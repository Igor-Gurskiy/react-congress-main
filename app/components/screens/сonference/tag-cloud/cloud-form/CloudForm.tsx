...
const CloudForm = ({ tags = [] as any[], addWord = (word: Word) => {} }) => {
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} className={styles.wrapper}>
				...
				{isSubmitted && (
					...
					>
						...
						<div className={clsx(styles.description, styles.fullWidth)}>
							Вы можете добавить еще слова-ассоциации с{' '}
							<b>L'Oreal Dermatological Beauty</b> и&nbsp;увидите какие,
							ассоциации чаще всего вызывает упоминание подразделения
							среди&nbsp;специалистов
						</div>
					</motion.div>
				)}
			...
			{!isSubmitted && (
				<div className={clsx(styles.description, styles.fullWidth)}>
					Впишите свое слово-ассоциацию с <b>L'Oreal Dermatological Beauty</b> и
					увидите, какие ассоциации чаще всего вызывает упоминание подразделения
					среди&nbsp;специалистов
				</div>
			)}
			<div>
