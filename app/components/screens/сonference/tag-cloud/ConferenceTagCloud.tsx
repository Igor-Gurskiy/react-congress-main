...
import CloudForm from '@/components/screens/сonference/tag-cloud/cloud-form/CloudForm'
import { modifyCloudSetWithWord } from '@/utils/modify-cloud-set'

const MediaQuery = dynamic(() => import('react-responsive'), { ssr: false })

const ConferenceTagCloud = ({ cloud, preview }) => {
	...
	return (
		<Wrapper>
			<FormulaBack color="#fff" link="/conference" />
...
export default ConferenceTagCloud
...
export const Wrapper = styled.div`
	background: url(../assets/images/conference/cloud/bg.jpg);
