...
const DayThreeSchedule = forwardRef<HTMLDivElement, any>(({ close }, ref) => {
	const { getScheduleCurrentState } = useScheduleCurrentState()
	const daySchedule = useScheduleSelector('2023-12-02')
	const status = getScheduleCurrentState('2023-12-02')
