...
const DayFourSchedule = forwardRef<HTMLDivElement, any>(({ close }, ref) => {
	const { getScheduleCurrentState } = useScheduleCurrentState()
	const daySchedule = useScheduleSelector('2023-12-03')
	const status = getScheduleCurrentState('2023-12-03')
					...
					<Schedule.Header>
						...
						<div className="text">
							<h1>
								...
								<span className="title2">ОНКОЛОГИя</span>
							</h1>
						</div>
					</Schedule.Header>
