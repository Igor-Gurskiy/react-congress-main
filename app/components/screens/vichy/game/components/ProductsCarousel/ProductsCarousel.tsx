...
import CarouselItem, {
	ICaseItem,
} from '@/components/screens/vichy/game/components/ProductsCarousel/CarouselItem'
import CarouselArrowIcon from '@/components/screens/vichy/game/components/ProductsCarousel/CarouselArrowIcon'
