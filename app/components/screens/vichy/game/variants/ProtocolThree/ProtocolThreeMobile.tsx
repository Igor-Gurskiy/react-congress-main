...
import styles from './ProtocolThreeMobile.module.scss'
		...
		<div className={styles.wrapper}>
			<div className={styles.content}>
				<div className={styles.column}>
					<img
						src="/assets/images/vichy/game/case3/person2.png"
									...
									<AnimatePresence mode="wait">
										{!selection && (
											...
											>
												...
												<li className={styles.listItem}>
													На снижение тонуса кожи
												</li>
												<li className={styles.listItem}>
													На чувствительность кожи, склонность к появлению
													шелушения
												</li>
												<li className={styles.listItem}>
...
export default ProtocolThreeMobile
