...
import FormulaScene from "@/components/screens/vichy/formula/scene/FormulaScene";
import FormulaBack from "@/components/screens/vichy/formula/shared/FormulaBack";
import FormulaBottle from "@/components/screens/vichy/formula/shared/bottle/FormulaBottle";
import FormulaHeader from "@/components/screens/vichy/formula/shared/header/FormulaHeader";
import {getSeconds} from "date-fns";
import VichyFormulaIngredients from "@/components/screens/vichy/formula/VichyFormulaIngredients";
import FormulaImagePreloader from "@/components/screens/vichy/formula/FormulaImagePreloader";
import {API} from "@/api";
import {EventsEnum} from "@/api/tracker";

export const initialVichyFormulaState = {
    score: 0,
    layers: [],
    ids: [],
    finished: false,
...
const VichyFormula = () => {
    const [state, dispatch] = useReducer(vichyFormulaReducer, initialVichyFormulaState)
    const {score} = state
    ...
    useEffect(() => {
        ...
        API.tracker.sendEvent(EventsEnum.vichyGame)
        ...
        return () => document.removeEventListener('vichy-formula-add', handleScore, false)
    }, [])
