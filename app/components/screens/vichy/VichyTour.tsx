...
const VichyTour = () => {
	...
	useEffect(() => {
		if (!isLoading && !preloader && tour === 'vichy') {
			setStep(1)
			setHelpTour(false)
		}
		return
	...
	return (
		<Tour open={tour === 'vichy'}>
			{!isMobile && (
				<>
					...
					<Tour.Step
						...
						skip={skip}
					/>
					<Tour.Arrow open={step === 1} left={1600} top={380} rotate={270} />
					<Tour.Arrow open={step === 2} left={850} top={280} rotate={270} />
					<Tour.Arrow open={step === 3} left={1700} top={220} rotate={90} />
				</>
			)}

			{isMobile && (
				<>
					<Tour.Arrow open={step === 1} left={1110} top={-70} rotate={180} />
					<Tour.Arrow open={step === 2} left={370} top={-80} rotate={180} />
					<Tour.Arrow open={step === 3} left={2040} top={-80} rotate={180} />
				</>
			)}
			<Tour.Light
				src="assets/images/vichy/light/shelf-light.png"
				open={step === 1}
				top={120}
				left={908}
			/>
			...
			{/*TODO: CLOUD LIGHT*/}
			{/*<Tour.Light*/}
			{/*	src="assets/images/vichy/light/cloud.png"*/}
			{/*	open={step === 2}*/}
			{/*	top={241}*/}
			{/*	left={184}*/}
			{/*/>*/}
			...
			<Tour.Light
				src="assets/images/vichy/light/game-light.png"
				open={step === 3}
				top={185}
				left={1955}
			/>
